#### Code for step 1 analysis of MIMAS output ####
...
total_sims <- 100000
training_files <- lapply(Sys.glob("data/training_runs/YBSA/4_10_22/Step_1/YBSA*.csv"), read.csv)
#training_files[[1]]
...
fall_param_inx <- c(4,5,8,9,14,15,17,19,26)
spring_param_inx <- c(2,3,6,7,12,13,16,18,25)
shared_inx <- c(23,24)
constant_inx <- c(10,11,20,21,22)
colnames(top_f_models)[fall_param_inx]
colnames(top_s_models)[spring_param_inx]
colnames(top_f_models)[shared_inx]

pdf(file = "~/Documents/Coding/R/M-IBM/data/output/S1_convergence.pdf",   # The directory you want to save the file in

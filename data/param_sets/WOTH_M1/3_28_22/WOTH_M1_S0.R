#Parameter set based on all data up until 2021.
...
speed_mean_f <- rtruncnorm(1,a=0,mean=300,sd=200)
...
mig_con <- rtruncnorm(1,a=0,b=1,mean=.7,sd=.3)
...
mig_con_type <- ceiling(runif(1,.5,2))

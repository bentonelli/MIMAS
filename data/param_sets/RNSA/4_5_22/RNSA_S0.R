...
#Define species name
species_target <- "Red-naped Sapsucker"
...
#Energetics info
max_energy_s <- rtruncnorm(1,a=0,mean=4000,sd=2000)
max_energy_f <- rtruncnorm(1,a=0,mean=4000,sd=2000)

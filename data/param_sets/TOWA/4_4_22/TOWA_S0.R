...
#Energetics info
max_energy_s <- rtruncnorm(1,a=0,mean=3000,sd=2000)
max_energy_f <- rtruncnorm(1,a=0,mean=3000,sd=2000)
recovery_rate_s <- rtruncnorm(1,a=0,b=1,mean=.2,sd=.2)
recovery_rate_f <- rtruncnorm(1,a=0,b=1,mean=.2,sd=.2)

#Migration time max - seems to have an extended migratory calendar!
max_mig_time_s <- 150
max_mig_time_f <- 150
...
# Migratory connectivity type - not enough prior parameter information on this to change

#### Paramter set for the Hooded Warbler ####


#Define species name
species_target <- "Hooded Warbler"
...
start_date_u_s <- rtruncnorm(1,a=1,b=365,mean=75,sd=20)

#Spring migration dates standard deviation
start_date_sd_s <- rtruncnorm(1,a=0,mean=15,sd=15)

#Fall migration dates 
start_date_u_f <- rtruncnorm(1,a=1,b=365,mean=240,sd=20)

start_date_sd_f <- rtruncnorm(1,a=0,mean=15,sd=15)

...
start_date_u_s <- rtruncnorm(1,a=1,b=365,mean=100,sd=15)

#Spring migration dates standard deviation
start_date_sd_s <- rtruncnorm(1,a=0,mean=10,sd=10)

#Fall migration dates 
start_date_u_f <- rtruncnorm(1,a=1,b=365,mean=230,sd=15)

start_date_sd_f <- rtruncnorm(1,a=0,mean=10,sd=10)
...
#Energetics info
max_energy_s <- rtruncnorm(1,a=0,mean=3000,sd=1500)
max_energy_f <- rtruncnorm(1,a=0,mean=3000,sd=1500)

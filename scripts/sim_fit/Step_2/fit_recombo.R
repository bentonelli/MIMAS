...
posterior_params <- readRDS("data/fit_param_sets/VATH/Step_1/VATH_3_11_22.rds")

# Determine names of output files
file_name_start <- "VATH_S2_3_11_22_"
...
fn <- paste(file_name_start,ceiling(runif(1,1,99999)),".csv",sep="")
